...
/*   Updated: 2023/07/29 15:30:56 by amalbrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Default ClapTrap Constructor Used" << std::endl;
}
...
{
	// std::cout << "Claptrap Copy Constructor Used" << std::endl;
	*this = copy;
}

ClapTrap & ClapTrap::operator=(ClapTrap const &rhs)
{
	// std::cout << "Claptrap Equals Operator Used" << std::endl;
	if (this != &rhs)
	{
...
ClapTrap::~ClapTrap()
{
	std::cout << "Default Claptrap Deconstructor Used" << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	else
	{
		...
		std::cout << this->_name << " takes " << amount << " of damage," << " leaving them with "
